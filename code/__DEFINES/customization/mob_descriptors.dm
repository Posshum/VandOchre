...
#define MOB_DESCRIPTOR_SLOT_PENIS 11
#define MOB_DESCRIPTOR_SLOT_TESTICLES 12
#define MOB_DESCRIPTOR_SLOT_BREASTS 13
#define MOB_DESCRIPTOR_SLOT_VAGINA 14
#define MOB_DESCRIPTOR_SLOT_HEIGHT 15
