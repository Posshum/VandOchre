...
#define BODY_FRONT_FIFTH_LAYER	8		//I hate genital code and .dmi bullshittery. 5 layers to accomodate for such.
#define BODY_FRONT_FOURTH_LAYER	7
#define BODY_FRONT_THIRD_LAYER	6
#define BODY_FRONT_SECOND_LAYER	5
