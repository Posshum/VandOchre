...
//Age ranges
#define AGE_YOUNG_ADULT		"Young Adult"
...
#define NORMAL_AGES_LIST_CHILD		list(AGE_YOUNG_ADULT, AGE_ADULT, AGE_MIDDLEAGED, AGE_OLD)
#define ALL_AGES_LIST				list(AGE_ADULT, AGE_MIDDLEAGED, AGE_OLD, AGE_IMMORTAL)
#define ALL_AGES_LIST_CHILD			list(AGE_YOUNG_ADULT, AGE_ADULT, AGE_MIDDLEAGED, AGE_OLD, AGE_IMMORTAL)
