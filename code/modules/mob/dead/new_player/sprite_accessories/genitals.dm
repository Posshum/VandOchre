/datum/sprite_accessory/penis
	icon = 'icons/mob/sprite_accessory/genitals/peniss.dmi'
	color_keys = 2
	color_key_names = list("Member", "Skin")
	relevant_layers = list(BODY_FRONT_LAYER, BODY_ADJ_LAYER, BODY_FRONT_SECOND_LAYER)
...
/* /datum/sprite_accessory/penis/thick
	...
	name = "Thick"
	color_key_defaults = list(null, KEY_CHEST_COLOR)
	default_colors = list("C52828", null) */ //Same as plain so too bad bye bye.
...
/datum/sprite_accessory/vagina
	...
	relevant_layers = list(BODY_FRONT_THIRD_LAYER)
